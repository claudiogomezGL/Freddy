...
public struct JSONParser {
    ...
    private mutating func readUnicodeEscape(start: Int) throws {
        ...
        let transcodeHadError = transcode(UTF16.self, UTF8.self, codeUnits.makeIterator(), { self.stringDecodingBuffer.append($0) }, stopOnError: true)
    ...
    private func detectingFloatingPointErrors<T>(_ loc: Int, @noescape _ f: () throws -> T) throws -> T {
